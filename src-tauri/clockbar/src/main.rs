...
const PIPE_NAME: &str = r"\\.\pipe\lical-clockbar-b62"; // 与 tap.cpp TAPVER 版本化一致
...
const TAP_DLL: &str = r"D:\project\li-calendar\src-tauri\clockbar\bin\lical_clock_tap58.dll";
const TAP_VER: &str = "62";
