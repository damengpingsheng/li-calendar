...
const PIPE_NAME: &str = r"\\.\pipe\lical-clockbar-b55"; // 与 tap.cpp TAPVER 版本化一致
...
const TAP_DLL: &str = r"D:\project\li-calendar\src-tauri\clockbar\bin\lical_clock_tap55.dll";
const TAP_VER: &str = "55";
