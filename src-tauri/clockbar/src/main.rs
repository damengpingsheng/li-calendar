...
const PIPE_NAME: &str = r"\\.\pipe\lical-clockbar-b57"; // 与 tap.cpp TAPVER 版本化一致
...
const TAP_DLL: &str = r"D:\project\li-calendar\src-tauri\clockbar\bin\lical_clock_tap57.dll";
const TAP_VER: &str = "57";
