...
cd /d %~dp0
cl /nologo /LD /MT /EHsc /O2 /W3 /utf-8 /DTAPVER=%TAPVER% tap.cpp /Fe:..\bin\lical_clock_tap%TAPVER%.dll /link /nologo /DLL /DEF:tap.def User32.lib ole32.lib OleAut32.lib
